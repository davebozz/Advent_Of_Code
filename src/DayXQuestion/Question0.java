...
public class Question0 {
	...
	public static void main() {
		...
		ArrayList<String> letterMoves = new ArrayList<>();
		ArrayList<Integer> numMoves = new ArrayList<>();
		ArrayList<Rambler> ramblerMoves = new ArrayList<>();
	...
	private static void initAndRead(ArrayList<String> letter, ArrayList<Integer> numbers) {
		//File to be read in
	...
	private static void checkRepeatVisit(Rambler rambler, ArrayList<Rambler> ramblerArrList) {
